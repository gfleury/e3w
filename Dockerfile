...
RUN mkdir -p /go/src/github.com/gfleury/e3w
ADD . /go/src/github.com/gfleury/e3w
WORKDIR /go/src/github.com/gfleury/e3w
...
COPY --from=backend /go/src/github.com/gfleury/e3w/e3w /app
